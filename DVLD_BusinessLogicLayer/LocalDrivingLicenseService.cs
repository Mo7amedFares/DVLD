...
namespace DVLD_BusinessLogicLayer
{
    public class LocalDrivingLicenseService : RequestService
    {
        ...
        public LocalDrivingLicenseService(int Requst_id , int? Base_Request_ID, int user_id, DateTime date,DateTime lastStatusDate, enState state, int created_by_system_user, decimal paidFees, int License_Class_ID) : base(Base_Request_ID, user_id, date,lastStatusDate, state, created_by_system_user, paidFees, 1)
        {
            AddOrUpdate = enAddOrUpdate.Update;
            this.Request_id = Requst_id;
            this.License_Class_ID = License_Class_ID;
        }
        public LocalDrivingLicenseService(int Local_Driving_License_Id) : base()
        {
            AddOrUpdate = enAddOrUpdate.Update;
        ...
        public void loadLocalDrivingLicense()
        {
            DataTable dt = DVLD_DataAccessLayer.LocalDrivingLicenseRepository.GetLocalDrivingLicenseByID(this.Local_Driving_License_Id);
            if (dt.Rows.Count > 0)
            {
                DataRow row = dt.Rows[0];
                this.Local_Driving_License_Id = (int)row["Local_Driving_License_Id"];
                this.Request_id = (int)row["Request_id"];
                this.License_Class_ID = (int)row["License_Class_ID"];
                base.Request_ID = this.Request_id;
               
            }
        }

        public LocalDrivingLicenseService(int? Base_Request_ID, int user_id, DateTime date, DateTime lastStatusDate, enState state, int created_by_system_user, decimal paidFees, int License_Class_ID) : base(Base_Request_ID, user_id, date,lastStatusDate, state, created_by_system_user, paidFees, 1)
        {
        ...
        {
            return DVLD_DataAccessLayer.LocalDrivingLicenseRepository.GetRequestLocalDriverLicenseByRequestID(Request_ID);
        }
        ...
        public LocalDrivingLicenseService GetLocalDrivingLicenseByUserID(int user_id)
        {
            ...
            {
                DataRow row = dt.Rows[0];
                return new LocalDrivingLicenseService((int)row["Request_ID"], row["Base_Request_ID"] as int?, (int)row["user_id"], (DateTime)row["Date"],(DateTime)row["LastStatusDate"],(enState)(int)row["State"], (int)row["created_by_system_user"], (decimal)row["PaidFees"], (int)row["License_Class_ID"]);
            }
            return null;
        }
        ...
        {
            return DVLD_DataAccessLayer.LocalDrivingLicenseRepository.GetRequestLocalDrivingLicenseByUserID(user_id);
        }
        private bool AddLocalDrivingLicense()
        {
            ...
            if (requestId.HasValue)
            {
                ...
                this.Local_Driving_License_Id = DVLD_DataAccessLayer.LocalDrivingLicenseRepository.AddLocalDrivingLicense(this.Request_id, this.License_Class_ID);
                return this.Local_Driving_License_Id > 0;
            }
            return false;
        }
        ...
        {
            DataTable dt = DVLD_BusinessLogicLayer.LocalDrivingLicenseService.GetRequestLocalDrivingLicenseByUserID(this.user_id);
