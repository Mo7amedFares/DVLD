...
namespace DVLD_DataAccessLayer
{
    public class RequestRepository
    {
        ...
        public static int? AddRequest(int? Base_Request_ID, int user_id, DateTime date,DateTime lastStatusDate ,int state, int created_by_system_user, decimal paidFees, int requestType)
        {
            ...
            parameters.Add("@lastStatusDate", lastStatusDate);
        ...
        public static bool UpdateRequest(int Request_ID, int? Base_Request_ID, int user_id, DateTime date,DateTime lastStatusDate, int state, int created_by_system_user, decimal paidFees, int requestType)
        {
        ...
        public static bool ChangeRequestState(int Request_ID, int newState)
        {
            ...
            Dictionary<string, object> parameters = new Dictionary<string, object>();
            parameters.Add("@Request_ID", Request_ID);
            parameters.Add("@LastStatusDate" , DateTime.Now);
